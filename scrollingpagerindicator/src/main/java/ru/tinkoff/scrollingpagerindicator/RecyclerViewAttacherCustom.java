 ...
 */
public class RecyclerViewAttacherCustom implements ScrollingPagerIndicator.PagerAttacher<RecyclerView> {

    private ScrollingPagerIndicator indicator;
    private RecyclerView recyclerView;
    private FocusLayoutManager layoutManager;
     ...
     * +------------------------------+
     */
    public RecyclerViewAttacherCustom() {
     ...
     */
    public RecyclerViewAttacherCustom(int currentPageOffset) {
...
//        }
        ...
        this.layoutManager = (FocusLayoutManager) pager.getLayoutManager();
    ...
    private void updateCurrentOffset() {
        ...
        float offset;
        if (layoutManager.getFocusOrientation() == FocusLayoutManager.FOCUS_LEFT || layoutManager.getFocusOrientation() == FocusLayoutManager.FOCUS_RIGHT) {
    ...
    private int findCompletelyVisiblePosition() {
        for (int i = 0; i < recyclerView.getChildCount(); i++) {
            ...
            if (layoutManager.getFocusOrientation() == FocusLayoutManager.FOCUS_TOP || layoutManager.getFocusOrientation() == FocusLayoutManager.FOCUS_BOTTOM) {
                position = child.getY();
